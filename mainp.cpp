...
int main()
{
    ...
    { // loop para repetição das etapas
        ...
        if (etapa == 1)
        {
            ...
            acessosEtapa1 = Lista1.bubbleSort(true); // recebe o retorno do metodo bubble sort que ira forncer o numero
        ...
        else if (etapa == 2)
        {
            ...
            { // 10   //enquanto o tamanho da lista nao for = 100 o while continuara a rodar
                ...
                aux = Lista2.bubbleSort(false); // aux recebe o retorno do metodo bubble sort que ira forncer o numero
                                                // de acessos a memoria e fara a ordenaçao da lista
